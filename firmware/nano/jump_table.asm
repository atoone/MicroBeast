...
.ENDIF
                    ...
                    JP          ni2c_ack            ; 19 (0FDC4h) - Send an i2c ACK.
                    ...
                    JP          ni2c_start          ; 9  (0FDE2h) - Sends I2C start sequence
                    JP          ni2c_stop           ; 8  (0FDE5h) - Sends I2C stop sequence
                    JP          ni2c_write          ; 7  (0FDE8h) - Write A as a byte to i2c bus. Carry SET if success. i2c_stop is not called.
                    JP          ni2c_read           ; 6  (0FDEBh) - Read byte from i2C into A, without ACK
                    JP          ni2c_write_to       ; 5  (0FDEEh) - Prepare to write to Device address H, Register L. Carry SET if success. i2c_stop is not called.
                    JP          ni2c_read_from      ; 4  (0FDF1h) - Read a byte int A from Device address H, Register L. Carry SET if success. i2c_stop is not called.
                    JP          wait_for_key        ; 3  (0FDF4h) - Waits for until a key is pressed and released
                    JP          play_nano           ; 2  (0FDF7h) - Plays the note defined by DE (octave, note) and C (duration, tenths)
